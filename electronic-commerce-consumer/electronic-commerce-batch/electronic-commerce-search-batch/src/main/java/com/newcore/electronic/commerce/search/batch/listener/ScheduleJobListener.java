package com.newcore.electronic.commerce.search.batch.listener;
...
import com.newcore.electronic.commerce.search.batch.quartz.QuartzManager;
...
public class ScheduleJobListener implements CommandLineRunner {
    ...
    private static final String JON_GROUP = "electronic-commerce-search-batch";
