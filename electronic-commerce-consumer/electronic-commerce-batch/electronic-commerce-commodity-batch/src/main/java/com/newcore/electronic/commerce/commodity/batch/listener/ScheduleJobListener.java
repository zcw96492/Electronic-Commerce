package com.newcore.electronic.commerce.commodity.batch.listener;
...
import com.newcore.electronic.commerce.commodity.batch.quartz.QuartzManager;
...
public class ScheduleJobListener implements CommandLineRunner {
    ...
    private static final String JON_GROUP = "electronic-commerce-commodity-batch";
