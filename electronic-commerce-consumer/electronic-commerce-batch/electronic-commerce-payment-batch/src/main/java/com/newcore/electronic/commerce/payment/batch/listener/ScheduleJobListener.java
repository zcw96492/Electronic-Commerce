package com.newcore.electronic.commerce.payment.batch.listener;
...
import com.newcore.electronic.commerce.payment.batch.quartz.QuartzManager;
...
public class ScheduleJobListener implements CommandLineRunner {
    ...
    private static final String JON_GROUP = "electronic-commerce-payment-batch";
