package com.newcore.electronic.commerce.shop.batch.listener;
...
import com.newcore.electronic.commerce.shop.batch.quartz.QuartzManager;
...
public class ScheduleJobListener implements CommandLineRunner {
    ...
    private static final String JON_GROUP = "electronic-commerce-shop-batch";
