package com.newcore.electronic.commerce.repository.batch.listener;
...
import com.newcore.electronic.commerce.repository.batch.quartz.QuartzManager;
...
public class ScheduleJobListener implements CommandLineRunner {
    ...
    private static final String JON_GROUP = "electronic-commerce-repository-batch";
