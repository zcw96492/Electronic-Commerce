package com.newcore.electronic.commerce.logistics.batch.listener;
...
import com.newcore.electronic.commerce.logistics.batch.quartz.QuartzManager;
...
public class ScheduleJobListener implements CommandLineRunner {
    ...
    private static final String JON_GROUP = "electronic-commerce-logistics-batch";
