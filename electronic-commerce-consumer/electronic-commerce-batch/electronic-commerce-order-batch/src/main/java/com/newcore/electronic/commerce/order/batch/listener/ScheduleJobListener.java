package com.newcore.electronic.commerce.order.batch.listener;
...
import com.newcore.electronic.commerce.order.batch.quartz.QuartzManager;
...
public class ScheduleJobListener implements CommandLineRunner {
    ...
    private static final String JON_GROUP = "electronic-commerce-order-batch";
