 ...
 */
public class OrderCommodityInfo implements Serializable {
    /**
     * 订单商品明细ID
     */
    private Integer orderCommodityInfoId;
     ...
     * @return  
     */
    public Integer getOrderCommodityInfoId() {
        return orderCommodityInfoId;
    }

    /**
     * 设置订单商品明细ID
     * @param orderCommodityInfoId 订单商品明细ID
     *
     * @date 2022-07-12 23:52:08
     */
    public void setOrderCommodityInfoId(Integer orderCommodityInfoId) {
        this.orderCommodityInfoId = orderCommodityInfoId;
    }
