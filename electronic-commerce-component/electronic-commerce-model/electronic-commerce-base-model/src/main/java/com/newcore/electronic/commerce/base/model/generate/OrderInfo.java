...
public class OrderInfo implements Serializable {
    ...
    /**
     * 设置订单来源     0-PC端订单；1-app订单
     * @param orderSource 订单来源     0-PC端订单；1-app订单
     *
     * @date 2022-07-12 23:52:08
     */
    ...
    /**
     * 设置订单评价星级(1-5的数值)
     * @param commentStarLevel 订单评价星级(1-5的数值)
     *
     * @date 2022-07-12 23:52:08
     */
    ...
    /**
     * 设置订单自动确认时间
     * @param autoConfirmTime 订单自动确认时间
     *
     * @date 2022-07-12 23:52:08
     */
